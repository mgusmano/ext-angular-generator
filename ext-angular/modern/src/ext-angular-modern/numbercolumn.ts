...
export class numbercolumnMetaData {
	...
	public static OUTPUTS: any[] = [
		...
		{name:'added',parameters:'numbercolumn,container,index'},
		...
		{name:'erased',parameters:'numbercolumn'},
		{name:'floatingchange',parameters:'numbercolumn,positioned'},
		...
		{name:'fullscreen',parameters:'numbercolumn'},
		{name:'heightchange',parameters:'sender,value,oldValue'},
		{name:'hiddenchange',parameters:'sender,value,oldValue'},
		{name:'hide',parameters:'numbercolumn'},
		{name:'initialize',parameters:'numbercolumn'},
		...
		{name:'moved',parameters:'numbercolumn,container,toIndex,fromIndex'},
		{name:'orientationchange',parameters:''},
		{name:'painted',parameters:'element'},
		{name:'positionedchange',parameters:'numbercolumn,positioned'},
		{name:'remove',parameters:'numbercolumn,item,index'},
		{name:'removed',parameters:'numbercolumn,container,index'},
		...
		{name:'updatedata',parameters:'numbercolumn,newData'},
