...
export class calendar_weekviewMetaData {
	...
	public static OUTPUTS: any[] = [
		{name:'added',parameters:'calendar-weekview,container,index'},
		...
		{name:'beforehide',parameters:'calendar-weekview'},
		...
		{name:'beforeshow',parameters:'calendar-weekview'},
		...
		{name:'erased',parameters:'calendar-weekview'},
		...
		{name:'floatingchange',parameters:'calendar-weekview,positioned'},
		...
		{name:'fullscreen',parameters:'calendar-weekview'},
		{name:'heightchange',parameters:'sender,value,oldValue'},
		{name:'hiddenchange',parameters:'sender,value,oldValue'},
		{name:'hide',parameters:'calendar-weekview'},
		{name:'initialize',parameters:'calendar-weekview'},
		{name:'leftchange',parameters:'sender,value,oldValue'},
		{name:'maxHeightchange',parameters:'sender,value,oldValue'},
		{name:'maxWidthchange',parameters:'sender,value,oldValue'},
		{name:'minHeightchange',parameters:'sender,value,oldValue'},
		{name:'minWidthchange',parameters:'sender,value,oldValue'},
		{name:'moved',parameters:'calendar-weekview,container,toIndex,fromIndex'},
		{name:'orientationchange',parameters:''},
		{name:'painted',parameters:'element'},
		{name:'positionedchange',parameters:'calendar-weekview,positioned'},
		{name:'removed',parameters:'calendar-weekview,container,index'},
		{name:'resize',parameters:'element,info'},
		{name:'rightchange',parameters:'sender,value,oldValue'},
		{name:'scrollablechange',parameters:'sender,value,oldValue'},
		{name:'show',parameters:'calendar-weekview'},
		{name:'tofront',parameters:'calendar-weekview'},
		{name:'topchange',parameters:'sender,value,oldValue'},
		{name:'updatedata',parameters:'calendar-weekview,newData'},
