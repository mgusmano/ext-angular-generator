...
export class calendar_daysheaderMetaData {
	...
	public static OUTPUTS: any[] = [
		{name:'added',parameters:'calendar-daysheader,container,index'},
		...
		{name:'beforehide',parameters:'calendar-daysheader'},
		...
		{name:'beforeshow',parameters:'calendar-daysheader'},
		...
		{name:'erased',parameters:'calendar-daysheader'},
		{name:'floatingchange',parameters:'calendar-daysheader,positioned'},
		...
		{name:'fullscreen',parameters:'calendar-daysheader'},
		{name:'heightchange',parameters:'sender,value,oldValue'},
		{name:'hiddenchange',parameters:'sender,value,oldValue'},
		{name:'hide',parameters:'calendar-daysheader'},
		{name:'initialize',parameters:'calendar-daysheader'},
		{name:'leftchange',parameters:'sender,value,oldValue'},
		{name:'maxHeightchange',parameters:'sender,value,oldValue'},
		{name:'maxWidthchange',parameters:'sender,value,oldValue'},
		{name:'minHeightchange',parameters:'sender,value,oldValue'},
		{name:'minWidthchange',parameters:'sender,value,oldValue'},
		{name:'moved',parameters:'calendar-daysheader,container,toIndex,fromIndex'},
		{name:'orientationchange',parameters:''},
		{name:'painted',parameters:'element'},
		{name:'positionedchange',parameters:'calendar-daysheader,positioned'},
		{name:'removed',parameters:'calendar-daysheader,container,index'},
		{name:'resize',parameters:'element,info'},
		{name:'rightchange',parameters:'sender,value,oldValue'},
		{name:'scrollablechange',parameters:'sender,value,oldValue'},
		{name:'show',parameters:'calendar-daysheader'},
		{name:'tofront',parameters:'calendar-daysheader'},
		{name:'topchange',parameters:'sender,value,oldValue'},
		{name:'updatedata',parameters:'calendar-daysheader,newData'},
