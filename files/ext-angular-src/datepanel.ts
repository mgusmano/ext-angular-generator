...
export class datepanelMetaData {
	...
	public static OUTPUTS: any[] = [
		...
		{name:'added',parameters:'datepanel,container,index'},
		...
		{name:'beforehide',parameters:'datepanel'},
		...
		{name:'beforeshow',parameters:'datepanel'},
		...
		{name:'erased',parameters:'datepanel'},
		{name:'expand',parameters:'datepanel'},
		{name:'floatingchange',parameters:'datepanel,positioned'},
		...
		{name:'fullscreen',parameters:'datepanel'},
		{name:'heightchange',parameters:'sender,value,oldValue'},
		{name:'hiddenchange',parameters:'sender,value,oldValue'},
		{name:'hide',parameters:'datepanel'},
		{name:'initialize',parameters:'datepanel'},
		...
		{name:'moved',parameters:'datepanel,container,toIndex,fromIndex'},
		{name:'orientationchange',parameters:''},
		{name:'painted',parameters:'element'},
		{name:'positionedchange',parameters:'datepanel,positioned'},
		{name:'remove',parameters:'datepanel,item,index'},
		{name:'removed',parameters:'datepanel,container,index'},
		...
		{name:'show',parameters:'datepanel'},
		{name:'tofront',parameters:'datepanel'},
		{name:'topchange',parameters:'sender,value,oldValue'},
		{name:'updatedata',parameters:'datepanel,newData'},
...
@Component({
  selector: datepanelMetaData.XTYPE,
	inputs: datepanelMetaData.INPUTNAMES,
	outputs: datepanelMetaData.OUTPUTNAMES,
	providers: [{provide: base, useExisting: forwardRef(() => datepanel)}],
	template: '<ng-template #dynamic></ng-template>'
})
export class datepanel extends base {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,datepanelMetaData);
	}
	//@ContentChildren(base,{read:ViewContainerRef}) extbaseRef:QueryList<ViewContainerRef>;
	@ContentChildren(base,{read: base}) extbaseRef: QueryList<base>;
	@ViewChild('dynamic',{read:ViewContainerRef}) dynamicRef:ViewContainerRef;
	ngAfterContentInit() {this.AfterContentInit(this.extbaseRef);}
	ngOnInit() {this.OnInit(this.dynamicRef,datepanelMetaData);}
}
