...
export class chartnavigatorMetaData {
	...
	public static OUTPUTS: any[] = [
		...
		{name:'added',parameters:'chartnavigator,container,index'},
		...
		{name:'erased',parameters:'chartnavigator'},
		{name:'floatingchange',parameters:'chartnavigator,positioned'},
		...
		{name:'fullscreen',parameters:'chartnavigator'},
		{name:'heightchange',parameters:'sender,value,oldValue'},
		{name:'hiddenchange',parameters:'sender,value,oldValue'},
		{name:'hide',parameters:'chartnavigator'},
		{name:'initialize',parameters:'chartnavigator'},
		...
		{name:'moved',parameters:'chartnavigator,container,toIndex,fromIndex'},
		{name:'orientationchange',parameters:''},
		{name:'painted',parameters:'element'},
		{name:'positionedchange',parameters:'chartnavigator,positioned'},
		{name:'remove',parameters:'chartnavigator,item,index'},
		{name:'removed',parameters:'chartnavigator,container,index'},
		...
		{name:'updatedata',parameters:'chartnavigator,newData'},
